...
__device__ __forceinline__ tensorflow::bfloat16 __ldg(const tensorflow::bfloat16 *ptr)
{
    tensorflow::bfloat16 ret;
    asm volatile ("ld.global.nc.u16 %0, [%1];" : "=h"(ret.value) : "l"(ptr));
    return ret;
}
